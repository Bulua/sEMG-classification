...
def main():
    ...
    # 所选sEMG特征
    selected = ['WL', 'MEAN', 'SSC', 'WMAV']
    # ['MAV', 'RMS', 'STD', 'SSI', 'VAR', 'AAC']
    ready_features = ['MAV', 'RMS', 'STD', 'SSI', 'VAR', 'AAC']
    # 可选
    # selected = ['WMAV', 'STD', 'SSI', 'MEAN']
    # ready_features = ['MAV', 'SSC', 'WL', 'RMS', 'VAR', 'AAC']
    ...
    plot_save(selected_f, accs, path=SEMG_FEATURE_SELECT_PATH, figname='five_feature')
