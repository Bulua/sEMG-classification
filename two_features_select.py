...
def main():
    ...
    # 备选特征  ['MAV', 'WMAV', 'SSC', 'WL', 'RMS','STD', 'SSI', 'VAR', 'AAC', 'MEAN']
    ready_features = ['MAV', 'SSC', 'WL', 'RMS','STD', 'SSI', 'VAR', 'AAC', 'MEAN']
    selected_f = list(product(selected, ready_features))
    print(selected_f)
    accs = []
    ...
    plot_save(selected_f, accs, path=ACC_FEATURE_SELECT_PATH, figname='two_feature')
