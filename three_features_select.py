...
def main():
    ...
    # ['MAV', 'WMAV', 'SSC', 'WL', 'RMS','STD', 'SSI', 'VAR', 'AAC', 'MEAN']
    ready_features = ['MAV', 'SSC', 'WL', 'RMS', 'SSI', 'VAR', 'AAC', 'MEAN']
    ...
    plot_save(selected_f, accs, path=ACC_FEATURE_SELECT_PATH, figname='three_feature')
